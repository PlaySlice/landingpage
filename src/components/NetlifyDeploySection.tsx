...
import { ArrowRight, Rocket, Terminal, Cloud, Server, RefreshCw } from "lucide-react";
...
const steps = [
  {
    ...
    description: "Link your Netlify account with our platform with a single click.",
    icon: <Terminal className="w-4 h-4" />
  },
  {
    id: "02",
    title: "Generate Your Project",
    description: "Use our AI tools to create your website, landing page, or web application.",
...
const NetlifyDeploySection = ({ isWeb3 = false }) => {
  ...
  return (
    <section
      ref={sectionRef}
      className={`py-32 relative overflow-hidden ${isWeb3 ? "bg-[#FF5C3A]/5" : "bg-black/5"}`}
    >
      <AnimatedStarsBackground burst={isWeb3} />
      
      {/* Background elements */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className={`absolute -right-40 top-1/4 w-96 h-96 rounded-full opacity-10 ${isWeb3 ? 'bg-[#FF5C3A]' : 'bg-blue-500'} blur-3xl`}></div>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              <div className={`mb-6 inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium ${
                isWeb3 
              ...
              <p className={`text-lg mb-10 ${
                ...
                Focus on creating amazing web experiences, not on 
                deployment processes. With our automatic Netlify
                integration, your sites go live instantly.
              </p>
            ...
            >
              ...
              >
                ...
                <div className={`absolute inset-0 backdrop-blur-[2px] z-10 border rounded-2xl ${
                  isWeb3 
                  ...
                  <div className="w-[90%] max-w-xl aspect-[5/3] bg-neutral-900 rounded-xl shadow-2xl overflow-hidden border border-neutral-800">
                    ...
                    <div className="p-5 font-mono text-sm text-white/90 space-y-3 h-full">
                      <div className="flex items-center">
                        ...
                        <span className="text-white">netlify deploy --prod</span>
                      </div>
                ...
                >
                  <div className={`rounded-lg bg-white/10 backdrop-blur-md px-4 py-2 border ${
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`text-sm ${
                        isWeb3 ? "text-[#18181b]" : "text-white"
                      } font-medium`}>Live on Netlify</span>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
