...
const steps = [
  {
    ...
    description: "Link your wallet with our platform with a single click",
    icon: <Terminal className="w-4 h-4" />,
  },
  {
    number: "02",
    title: "Generate Your Contract",
    description: "Use our AI tools to create your Solana program",
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
            ...
            >
              <div
                className={`mb-6 inline-flex items-center px-4 py-1.5 rounded-full text-sm font-medium ${
                  isWeb3
                    ...
                    : " text-blue-800 dark:bg-dark-900/30 dark:text-blue-400"
                }`}
              >
                <Rocket
              ...
              >
                ...
                processes. With our Deploy on Solana feature, your dApps go live
                instantly.
              </p>
                    ...
                    <div className="flex-shrink-0 mr-4">
                      <div
                        className={`w-10 h-10 rounded-full ${
                          isWeb3
                            ? "bg-white/10 border border-[#18181b]/40"
            ...
            <motion.div style={{ y }} className="lg:col-span-7 relative">
              <motion.div
              ...
              >
                ...
                <div
                  className={`absolute inset-0 ${
                    isWeb3 ? "bg-white/5" : "bg-white/5 dark:bg-black/10"
                  } backdrop-blur-[2px] z-10 border border-white/20 rounded-2xl`}
                ></div>
